...
### Demo Overview
This demo is based on Red Hat Openshift and Red Hat middleware (Node.js, SpringBoot and Red Hat Fuse). Also use a version of the Open Source project [Open Bank Project](https://www.openbankproject.com/).
...
**Event:** Red Hat Tech Exchange 2019 - Openbank at Scale Team 
